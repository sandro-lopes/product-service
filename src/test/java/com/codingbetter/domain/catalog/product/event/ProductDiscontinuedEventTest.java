...
@DisplayName("ProductDiscontinuedEvent Tests")
class ProductDiscontinuedEventTest {
    ...
    void shouldHaveUniqueIdForEachEvent() {
        ...
        // Act
        ProductDiscontinuedEvent event1 = new ProductDiscontinuedEvent(productId);
        ProductDiscontinuedEvent event2 = new ProductDiscontinuedEvent(productId);
